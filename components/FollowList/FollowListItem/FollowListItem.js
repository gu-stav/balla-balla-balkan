...
const FollowListItem = ({ type, href, label, theme }) => {
  const iconMap = {
    apple: PodcastIcon,
  ...
  return (
    <Link href={href}>
      <a
        ...
        aria-label={`Folge dem Podcast auf ${label}`}
      >
        <Icon />
      </a>
    </Link>
